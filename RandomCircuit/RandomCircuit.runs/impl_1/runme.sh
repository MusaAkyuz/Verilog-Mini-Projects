...
HD_PWD='C:/Users/musak/RandomCircuit/RandomCircuit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tumleyenlicikarma.vdi -applog -m64 -messageDb vivado.pb -mode batch -source tumleyenlicikarma.tcl -notrace
