...
HD_PWD='C:/Users/musak/RandomCircuit/RandomCircuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tumleyenlicikarma.vds -m64 -mode batch -messageDb vivado.pb -notrace -source tumleyenlicikarma.tcl
