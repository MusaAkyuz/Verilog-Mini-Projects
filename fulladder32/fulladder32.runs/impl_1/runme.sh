...
HD_PWD='C:/Users/musak/fulladder32/fulladder32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder32bit.vdi -applog -m64 -messageDb vivado.pb -mode batch -source fulladder32bit.tcl -notrace
