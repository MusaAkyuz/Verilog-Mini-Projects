...
HD_PWD='C:/Users/musak/fulladder32/fulladder32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder32bit.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fulladder32bit.tcl
