...
HD_PWD='C:/Users/musak/trafikisigi/trafikisigi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rockpaperscissors.vds -m64 -mode batch -messageDb vivado.pb -notrace -source rockpaperscissors.tcl
