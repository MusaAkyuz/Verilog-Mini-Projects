...
HD_PWD='C:/Users/musak/trafikisigi/trafikisigi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rockpaperscissors.vdi -applog -m64 -messageDb vivado.pb -mode batch -source rockpaperscissors.tcl -notrace
