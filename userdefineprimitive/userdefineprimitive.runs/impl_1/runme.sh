...
HD_PWD='C:/Users/musak/userdefineprimitive/userdefineprimitive.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log primitives.vdi -applog -m64 -messageDb vivado.pb -mode batch -source primitives.tcl -notrace
