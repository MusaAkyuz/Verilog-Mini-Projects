...
HD_PWD='C:/Users/musak/userdefineprimitive/userdefineprimitive.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log primitives.vds -m64 -mode batch -messageDb vivado.pb -notrace -source primitives.tcl
